...
class PayslipController extends AbstractController
{
    ...
    public function __construct(
     ...
     /**
      * 一覧画面.
      * @Route("/%eccube_admin_route%/payslip", name="admin_payslip", methods={"GET", "POST"})
      * @Route("/%eccube_admin_route%/payslip/page/{page_no}", requirements={"page_no" = "\d+"}, name="admin_payslip_page", methods={"GET", "POST"})
      * @Template("@admin/Payslip/index.twig")
      */
      public function index(Request $request, PaginatorInterface $paginator, $page_no = null)
      {
          ...
          $qb = $this->payslipRepository->getQueryBuilderBySearchData($searchData);
