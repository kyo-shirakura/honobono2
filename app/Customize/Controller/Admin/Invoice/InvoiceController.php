...
class InvoiceController extends AbstractController
{
    ...
    public function __construct(
     ...
     /**
      * 一覧画面.
      * @Route("/%eccube_admin_route%/invoice", name="admin_invoice", methods={"GET", "POST"})
      * @Route("/%eccube_admin_route%/invoice/page/{page_no}", requirements={"page_no" = "\d+"}, name="admin_invoice_page", methods={"GET", "POST"})
      * @Template("@admin/Invoice/index.twig")
      */
      public function index(Request $request, PaginatorInterface $paginator, $page_no = null)
      {
          ...
          $qb = $this->invoiceRepository->getQueryBuilderBySearchData($searchData);
