 ...
 * Payslip
 *
 * @ORM\Table(name="dtb_payslip_issue_add_item")
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Entity(repositoryClass="Customize\Repository\PayslipIssueAddItemRepository")
 * @ORM\Cache(usage="NONSTRICT_READ_WRITE")
 */
class PayslipIssueAddItem extends AbstractEntity
{
    /**
     * @var int
     *
