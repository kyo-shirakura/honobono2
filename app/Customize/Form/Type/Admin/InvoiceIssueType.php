...
/**
 * Class InvoiceIssuedType.
 */
class InvoiceIssueType extends AbstractType
{
    /** @var EccubeConfig */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            // 複数
            ->add('item_title', EntityType::class, [
                'class' => InvoiceAddItems::class,
...
/*
            ->add('item_title__', CollectionType::class, [
                'required' => false,
            ...
            ->add('item_amout', CollectionType::class, [
                'required' => false,
                'entry_type' => TextType::class,
            ])
            ->add('item_remark', CollectionType::class, [
                'required' => false,
                'entry_type' => TextType::class,
                'attr' => ['maxlength' => $config['eccube_stext_len']],
                'constraints' => [
