...
*/
          ...
          ->add('work_details', WorkDetailsType::class, [
              ...
              'multiple' => true,
              'expanded' => true,
//              'data' => $this->workDetailsRepository->findAll(),
//                'mapped' => false,
          ])
...
//                'label' => 'admin.report.work_other',
          ...
          ->add('safety_confirmation', SafetyConfirmationType::class, [
              ...
              'multiple' => true,
              'expanded' => true,
//              'data' => $this->safetyConfirmationRepository->find(11),
//                'mapped' => false,
          ])
          ->add('payment_deposit', TextType::class, [
              'label' => 'admin.report.payment_deposit',
              'required' => false,
              //'attr' => ['readonly' => 'readonly'],
          ])
          ->add('payment_advance', TextType::class, [
              'label' => 'admin.report.payment_advance',
              'required' => false,
              //'attr' => ['readonly' => 'readonly'],
          ])
          ->add('payment_change', TextType::class, [
